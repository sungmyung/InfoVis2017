function Isosurfaces( volume, isovalue )
{
    ...
    function interpolated_vertex( v0, v1, s )
    {
        ...
        var v02 = v0.x + v0.y * volume.resolution.x + v0.z * volume.resolution.x * volume.resolution.y;
        var v12 = v1.x + v1.y * volume.resolution.x + v1.z * volume.resolution.x * volume.resolution.y;
        var x0 = volume.values[v02][0];
        var x1 = volume.values[v12][0];
